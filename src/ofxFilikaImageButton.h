...
public:
	...
	void enableMouseEvents() {
		ofAddListener(ofEvents().mousePressed, this, &ofxFilikaImageButton::mousePressed);
		ofAddListener(ofEvents().mouseMoved, this, &ofxFilikaImageButton::mouseMoved);
		ofAddListener(ofEvents().mouseDragged, this, &ofxFilikaImageButton::mouseDragged);
		ofAddListener(ofEvents().mouseReleased, this, &ofxFilikaImageButton::mouseReleased);
	}

	void disableMouseEvents() {
		ofRemoveListener(ofEvents().mousePressed, this, &ofxFilikaImageButton::mousePressed);
		ofRemoveListener(ofEvents().mouseMoved, this, &ofxFilikaImageButton::mouseMoved);
		ofRemoveListener(ofEvents().mouseDragged, this, &ofxFilikaImageButton::mouseDragged);
		ofRemoveListener(ofEvents().mouseReleased, this, &ofxFilikaImageButton::mouseReleased);
	}


	//--------------------------------------------------------------
	void enableTouchEvents() {
		ofAddListener(ofEvents().touchDown, this, &ofxFilikaImageButton::touchDown);
		ofAddListener(ofEvents().touchUp, this, &ofxFilikaImageButton::touchUp);
		ofAddListener(ofEvents().touchMoved, this, &ofxFilikaImageButton::touchMoved);
	}

	void disableTouchEvents() {
		ofRemoveListener(ofEvents().touchDown, this, &ofxFilikaImageButton::touchDown);
		ofRemoveListener(ofEvents().touchUp, this, &ofxFilikaImageButton::touchUp);
		ofRemoveListener(ofEvents().touchMoved, this, &ofxFilikaImageButton::touchMoved);
	}
