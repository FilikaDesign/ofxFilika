...
public:
	...
	void setup(int x, int y, int width, int height, int padding, ofTrueTypeFont &font, ofColor colorText, string _lang = "_TR") {
		...
		if(_lang == "_TR")
			...
			this->drawingText = "Enter your e-mail address, hit SEND key.";
