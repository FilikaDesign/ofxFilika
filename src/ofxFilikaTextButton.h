...
public:
	...
	void enableMouseEvents() {
		ofAddListener(ofEvents().mousePressed, this, &ofxFilikaTextButton::mousePressed);
		ofAddListener(ofEvents().mouseMoved, this, &ofxFilikaTextButton::mouseMoved);
		ofAddListener(ofEvents().mouseDragged, this, &ofxFilikaTextButton::mouseDragged);
		ofAddListener(ofEvents().mouseReleased, this, &ofxFilikaTextButton::mouseReleased);
	}

	void disableMouseEvents() {
		ofRemoveListener(ofEvents().mousePressed, this, &ofxFilikaTextButton::mousePressed);
		ofRemoveListener(ofEvents().mouseMoved, this, &ofxFilikaTextButton::mouseMoved);
		ofRemoveListener(ofEvents().mouseDragged, this, &ofxFilikaTextButton::mouseDragged);
		ofRemoveListener(ofEvents().mouseReleased, this, &ofxFilikaTextButton::mouseReleased);
	}


	//--------------------------------------------------------------
	void enableTouchEvents() {
		ofAddListener(ofEvents().touchDown, this, &ofxFilikaTextButton::touchDown);
		ofAddListener(ofEvents().touchUp, this, &ofxFilikaTextButton::touchUp);
		ofAddListener(ofEvents().touchMoved, this, &ofxFilikaTextButton::touchMoved);
	}

	void disableTouchEvents() {
		ofRemoveListener(ofEvents().touchDown, this, &ofxFilikaTextButton::touchDown);
		ofRemoveListener(ofEvents().touchUp, this, &ofxFilikaTextButton::touchUp);
		ofRemoveListener(ofEvents().touchMoved, this, &ofxFilikaTextButton::touchMoved);
	}
	////////////////////////////////////////////////
	// SETUP
	////////////////////////////////////////////////
