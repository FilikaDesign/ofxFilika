...
public:
	...
	void enableMouseEvents() {
		ofAddListener(ofEvents().mousePressed, this, &ofxFilikaTextButtonAnimated::mousePressed);
		ofAddListener(ofEvents().mouseMoved, this, &ofxFilikaTextButtonAnimated::mouseMoved);
		ofAddListener(ofEvents().mouseDragged, this, &ofxFilikaTextButtonAnimated::mouseDragged);
		ofAddListener(ofEvents().mouseReleased, this, &ofxFilikaTextButtonAnimated::mouseReleased);
	}

	void disableMouseEvents() {
		ofRemoveListener(ofEvents().mousePressed, this, &ofxFilikaTextButtonAnimated::mousePressed);
		ofRemoveListener(ofEvents().mouseMoved, this, &ofxFilikaTextButtonAnimated::mouseMoved);
		ofRemoveListener(ofEvents().mouseDragged, this, &ofxFilikaTextButtonAnimated::mouseDragged);
		ofRemoveListener(ofEvents().mouseReleased, this, &ofxFilikaTextButtonAnimated::mouseReleased);
	}


	//--------------------------------------------------------------
	void enableTouchEvents() {
		ofAddListener(ofEvents().touchDown, this, &ofxFilikaTextButtonAnimated::touchDown);
		ofAddListener(ofEvents().touchUp, this, &ofxFilikaTextButtonAnimated::touchUp);
		ofAddListener(ofEvents().touchMoved, this, &ofxFilikaTextButtonAnimated::touchMoved);
	}

	void disableTouchEvents() {
		ofRemoveListener(ofEvents().touchDown, this, &ofxFilikaTextButtonAnimated::touchDown);
		ofRemoveListener(ofEvents().touchUp, this, &ofxFilikaTextButtonAnimated::touchUp);
		ofRemoveListener(ofEvents().touchMoved, this, &ofxFilikaTextButtonAnimated::touchMoved);
	}
